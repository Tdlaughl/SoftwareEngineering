...
int main() {
    ...
    if (playAction == 1)
    {
        ...
        const sf::Time cooldownDuration = sf::milliseconds(250);
        ...
        while (window2.isOpen()) {
            ...
            if (cooldownTimer.getElapsedTime() >= cooldownDuration) {
                if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left))
                {
                    ...
                    if (redPlayerCount != 0)
                    {
                        ...
                        // playerSelectRed = playerSelectedPlace;
                    }
                    else
                    {
                        playerSelectRed = 0;
                    ...
                    if (random >= 9)
                    {
                        if (random == 9)
                        {
                            ...
                            {
                                firstName = "Base hit by ";
                                middleMessage = playerListRed[playerSelectRed].name;
                                playerListRed[playerSelectRed].hitBase = 1;
                                playerListRed[playerSelectRed].points = playerListRed[playerSelectRed].points + 100;

                                whiteText.setString(firstName);
                                redText.setString(middleMessage);

                                message.text1 = whiteText;
                                message.text2 = redText;

                                pointTotalRed = pointTotalRed + 100;


                            }
                            else
                            {
                                firstName = "Base already hit by ";
                                middleMessage = playerListRed[playerSelectRed].name;
                        ...
                        else if(random == 10)
                        {
                            ...
                            {
                                firstName = "Base hit in the gap by ";
                                middleMessage = playerListGreen[playerSelectGreen].name;
                                ...
                                message.text1 = whiteText;
                                message.text2 = greenText;

                                pointTotalGreen = pointTotalGreen + 100;
                            }
                            else
                            {
                                firstName = "Base already hit by ";
                    ...
                    else if(random < 9 && random > 5)
                    {
                        ...
                        firstName = playerListRed[playerSelectRed].name;
                        middleMessage = " hit ";
                        secondName = playerListGreen[playerSelectGreen].name;

                        playerListRed[playerSelectRed].points = playerListRed[playerSelectRed].points + 10;

                        redText.setString(firstName);
                        whiteText.setString(middleMessage);
                        greenText.setString(secondName);

                        message.text1 = redText;
                        message.text2 = whiteText;
                        message.text3 = greenText;

                        pointTotalRed = pointTotalRed + 10;
                    }
                    else if(random <= 5)
                    {

                        firstName = playerListGreen[playerSelectGreen].name;
                        middleMessage = " hit ";
            ...
            for(actionMessage& message : actionEvents)
            {
                ...
                message.text2.setPosition(message.text1.getGlobalBounds().width + xEventPos, yEventPos);
                message.text3.setPosition(message.text1.getGlobalBounds().width + message.text2.getGlobalBounds().width + xEventPos, yEventPos);

                window2.draw(message.text1);
                window2.draw(message.text2);
                window2.draw(message.text3);
